...
export function formatTime(milliseconds: number, minimal: boolean = false) {
    if (typeof milliseconds === "undefined" || isNaN(milliseconds)) {
        throw new RangeError("Utils#formatTime() Milliseconds must be a number greater than 0");
    }
...
export class Structure {
     ...
     */
    public static extend(name: keyof typeof Structures, extender: (klass: any) => any) {
